...
`annotations/` jest dopasowany do projektów z walidacją na anotacjach i grupami
(np. `groups={"Default","FirstStep"}`) — ma własny [README](annotations/README.md)
z integracją.
